...
public class HelpWorld extends World
{
    ...
    {    
        ...
        addObject(new Display("Powerups:",40,Color.WHITE),80,365);
        addObject(new Display(new GreenfootImage("Attack.png")),630,718);
        addObject(new Display("Attack speed, decreases reload time.",20,Color.WHITE),820,718);
        addObject(new Display(new GreenfootImage("Burst.png")),86,465);
        addObject(new Display("Burst, allows you to shoot bursts for some time.",20,Color.WHITE),310,465);
        addObject(new Display(new GreenfootImage("Life.png")),633,622);
        addObject(new Display("Life, gives you another life.",20,Color.WHITE),820,622);
        addObject(new Display(new GreenfootImage("Movement.png")),86,554);
        addObject(new Display("Speed, Increases your movement speed.",20,Color.WHITE),310,554);
        addObject(new Display(new GreenfootImage("Mystery.png")),86,640);
        addObject(new Display("Mystery, Gives you a random power-up.",20,Color.WHITE),310,640);
        addObject(new Display(new GreenfootImage("Penetrate.png")),86,727);
        addObject(new Display("Penetrating shot, allows your bullet to kill multiple ships.",20,Color.WHITE),310,727);
        addObject(new Display(new GreenfootImage("Score.png")),635,436);
        addObject(new Display("Score, increases your score & money.",20,Color.WHITE),820,436);
        addObject(new Display(new GreenfootImage("Shield.png")),633,533);
        addObject(new Display("Shield, gives you a shield that will protect you.",20,Color.WHITE),835,533);
    }
